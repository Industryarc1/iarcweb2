...
$mysqli = new mysqli("localhost","iarcdbmain","vpfjeVCuRqm4#5c9AhPeDdG6mGWX!jY6","iarcdb-live");
...
@page chapterTable {
    odd-footer-name: html_Chapter2FooterOdd;
    even-footer-name: html_Chapter2FooterEven;
  background:url(new-img/Page2.jpg) 100% 0;
  margin:9% 5%;
}
...
@page chaptersecondarysource {
    odd-footer-name: html_Chapter2FooterOdd;
    even-footer-name: html_Chapter2FooterEven;
  background:url(new-img/Page5.jpg) 100% 0;
  margin:9% 5%;
}
@page chapterresearchm1 {
    odd-footer-name: html_Chapter2FooterOdd;
    even-footer-name: html_Chapter2FooterEven;
  background:url(new-img/Page3.jpg) 100% 0;
  margin:9% 5%;
}
@page chapterresearchm2 {
    odd-footer-name: html_Chapter2FooterOdd;
    even-footer-name: html_Chapter2FooterEven;
  background:url(new-img/Page4.jpg) 100% 0;
  margin:9% 5%;
}
@page chapterindussol {
    odd-footer-name: html_Chapter2FooterOdd;
    even-footer-name: html_Chapter2FooterEven;
  background:url(new-img/Page8.jpg) 100% 0;
  margin:9% 5%;
}
@page chapterclientelec {
    odd-footer-name: html_Chapter2FooterOdd;
    even-footer-name: html_Chapter2FooterEven;
  background:url(new-img/Page7.jpg) 100% 0;
  margin:9% 5%;
}
...
@page chapteraboutiarc {
    odd-footer-name: html_Chapter2FooterOdd;
    even-footer-name: html_Chapter2FooterEven;
  background:url(new-img/Page9.jpg) 100% 0;
  margin:9% 5%;
}
@page chaptercontact {
    odd-footer-name: html_Chapter2FooterOdd;
    even-footer-name: html_Chapter2FooterEven;
  background:url(new-img/Page10.jpg) 100% 0;
  margin:9% 5%;
}
...
@page noheader {
  ...
  background:url(new-img/Page1.jpg)  50% 0;
}
div.noheader {
...
div.hd {
    font-size:11px;color:#ffffff;width:80%;padding-top:700px;font-weight:600;font-family:Open Sans;
}
div.hd2 {
...
<body>
<div class="noheader">
<div class="hd"><h2><font color="#33365D">'.$title.'</font></h2></div>
</div>
