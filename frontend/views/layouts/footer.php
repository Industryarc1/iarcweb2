...
<footer>
  ...
  <div class="social-footer">
      <ul>
       <li><a href="https://www.linkedin.com/company/industryarc"><img width="100%" height="100%" src="<?= Yii::$app->request->baseUrl ?>/images/linkedin-footer.svg" alt="LinkedIn" /></a></li>
       <li><a href="https://www.instagram.com/industry_arc/"><img width="100%" height="100%" src="<?= Yii::$app->request->baseUrl ?>/images/instagram-footer.svg" alt="Instagram"></a></li>
       <li><a href="https://twitter.com/IndustryARC"><img width="100%" height="100%" src="<?= Yii::$app->request->baseUrl ?>/images/twitter-footer.svg" alt="Twitter"></a></li>
       <li><a href="https://www.youtube.com/watch?v=Ico4CGzBlO0"><img width="100%" height="100%" src="<?= Yii::$app->request->baseUrl ?>/images/youtube-footer.svg" alt="Youtube"></a></li>
      </ul>
    </div>
  </div>
</footer>
