...
<footer>
  ...
  <div class="social-footer">
      <ul>
       <li><a href="https://www.linkedin.com/company/industryarc"><img width="100%" height="auto" src="<?= Yii::$app->request->baseUrl ?>/images/linkedin-footer.svg" alt="LinkedIn" /></a></li>
