            ...
            <div class="report-title" id="report">
                <div class="row">
                    ...
                    <div class="f-left p-relative">
                        <h1><?= CommonHelper::sanitizeContent($categoryDet['name']) ?> Market Research and Consulting Services</h1>
                                    ...
                                    <div class="collapse" id="<?= preg_replace('/\s+/', '_', $category['name']); ?>"> 
                                        <ul>
                                            ...
                                            foreach ($category['children'] as $childCat) {
                                                ...
                                                $urlsubcat = "https://www.industryarc.com/Domain/".$childCat['code']."/".$childCat['seo_keyword'];
                                                ?>
                    ...
                    <ul>
                        ...
                        foreach ($models as $report) {
							if ($report['dup_inc_id'] < 500000) {
								...
								$reportUrl = "https://www.industryarc.com/Report/".$report['dup_inc_id']."/".$report['curl'];
							} else {
								//$reportUrl = Url::to(['Research/' . $report['curl'] . '-' . $report['dup_inc_id']]);
								$reportUrl = "https://www.industryarc.com/Research/".$report['curl']."/".$report['dup_inc_id'];
							}
                            ?>
                            <li>
