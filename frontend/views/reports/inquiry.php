...
use yii\helpers\Url;
$this->title = 'IndustryARC - Inquiry Before Buying';
                ...
                <div class="form-container">
                    ...
                    <div class="col-md-5">
                        <div class="form form-bg-grey">
                            <p class="text-center rq-form-title"><strong>INQUIRY BEFORE BUYING</strong></p>
...
$(document).ready(function(e){
	...
	var country = $('#inquiryform-txtcountry').val();
	var allCountryDet = $countryDet;
	if(country != ''){
		$('.ph_extension').html(allCountryDet[country]['prefix']);
		$('#inquiryform-txtphoneext').val(allCountryDet[country]['prefix']);
	}
	$("#inquiryform-txtcountry").change(function(){
		var country = $(this).val();
		$('.ph_extension').html(allCountryDet[country]['prefix']);
		$('#inquiryform-txtphoneext').val(allCountryDet[country]['prefix']);
		//console.log($('#inquiryform-txtphoneext').val());
	});
