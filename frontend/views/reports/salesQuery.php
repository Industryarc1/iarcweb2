                ...
                <div class="form-container">
                    ...
                    <div class="col-md-6 offset-md-3">
                        <div class="form form-bg-grey">
                            <p class="text-center rq-form-title"><strong>SALES QUERY</strong></p>
                            ...
                            <p align="center">Your Emails are secure with us,<br> We will not include you in any subscriptions list</p>
                            <?php ActiveForm::end(); ?>
                        </div>
                    </div>
                </div>
...
$(document).ready(function(e){
	...
	var country = $('#salesqueryform-txtcountry').val();
	var allCountryDet = $countryDet;
	if(country != ''){
		$('.ph_extension').html(allCountryDet[country]['prefix']);
		$('#salesqueryform-txtphoneext').val(allCountryDet[country]['prefix']);
	}
	$("#salesqueryform-txtcountry").change(function(){
		var country = $(this).val();
		$('.ph_extension').html(allCountryDet[country]['prefix']);
		$('#salesqueryform-txtphoneext').val(allCountryDet[country]['prefix']);
		//console.log($('#salesqueryform-txtphoneext').val());
	});
