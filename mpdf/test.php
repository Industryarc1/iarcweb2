...
$mpdf=new mPDF(''); 
//==============================================================
$mpdf->SetHeader('<img src="000.jpg" class="img-responsive" alt="">');
...
$html = '
<style>.div-dh {width:100%;float:left;margin-top:300px;}</style>
<body style="background:url(00.jpg) 100%">
<div class="shadowtitle">New Features in mPDF v6.0</div>
<h3 class="div-dh">Images</h3>
