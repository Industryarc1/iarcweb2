...
if($_REQUEST['act']=="edit" && $_REQUEST['id']!=""){
	$cid=$_REQUEST['id'];
	if ($cat = $mysqli->prepare("select * from zsp_whitepapers where prod_id=?")) {
...
<div class="container">
    ...
    <div class="width100"  >
		<div class="topright width100 left">
			...
			<ul>
				<li>
				  <input type="submit" name="eidtwhitepapers" value="Save Whitepaper" class="forButton fixedclass" >
				</li>
			</ul>
		</div>
