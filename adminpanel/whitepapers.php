...
$sql="delete from zsp_whitepapers where prod_id='".$_REQUEST['rid']."'";
    ...
    <div class="width100"  >
		<div class="topright width100 left">
			...
			<ul >
			  ...
			  <?php /*?><li><a href="featured.php" class="forButton"  >Featured</a> &nbsp;</li><?php */?>
				<li><a href="addwhitepapers.php" ><i class="fa fa-plus-square"></i></a></li>
			    <?php /*?><li><a href="" ><i class="fa fa-trash"></i></a></li><?php */?>
			</ul>
	  </div>
		<div class="width100 left">
			<div class="head2"> <i class="fa fa-list"></i>white papers </div>
		...
		<div class="width100 left border" >
			<div class="width100 left border_bottom bgcolor1">
				<div class="head2 width60 left">white papers </div>
				<div class="head2 width20 left"></div>
				<div class="head2 width10 left">Action</div>
			</div>
			<?php 
				if ($stmt = $mysqli->prepare("select distinct(prod_id),title,sort_order,status,dt_created from zsp_whitepapers where ".@$cond." 1=1 order by dt_created desc")) {
			...
			<div class="width100 left border_bottom <?=$inactve?>">
				...
				<div class="head4 width10 left onoff"><a href="editwhitepapers.php?act=edit&id=<?=$prod_id?>" ><i class="fa fa-pencil-square"></i></a>
				
				&nbsp;
				<?php if($status==1){ ?>
				<a href="actions.php?act=editSatus&id=<?=$prod_id?>&changeWPStatus=0" ><i class="fa fa-check-circle"></i></a>
				<?php }?>
				<?php if($status==0){ ?>
				<a href="actions.php?act=editSatus&id=<?=$prod_id?>&changeWPStatus=1" ><i class="fa fa-circle-thin"></i></a>
				<?php }?>
				&nbsp;
				<a href="whitepapers.php?act=delete&rid=<?=$prod_id?>" ><i class="fa fa-trash"></i></a>
				</div>
			</div>
			<?php 
			} 
