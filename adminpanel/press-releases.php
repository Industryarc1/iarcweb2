	...
	<div class="container">
            ...
            <div class="box1" style="margin-top: 12px;">
                ...
                <div class="col5">
					...
					<?php
					$news=mysqli_query($mysqli,"select * from zsp_prs where status=1 order by prod_id desc ");
					if(mysqli_num_rows($news)>0){
					
					?>
					<div class="col5_right">
					    <div style="float:left;color:#666666" class="td_txt1">Press Releases </div>
                    </div>
                            	...
                            	<table width="100%" cellspacing="0" cellpadding="10px" bordercolor="#e4f3f4" border="1" style="border-collapse:collapse">
                                    ...
                                    <tr style="background-color:<?=$col?>">                                        
                                        <td class="f_txt1 td1" valign="middle">
                                        	<a href="PressRelease.php?id=<?=$n['prod_id']?>&title=<?=$n['seo_keyword']?>" class="tb_cont1">
                                            	<?=$n['title']?>
                                            </a>
