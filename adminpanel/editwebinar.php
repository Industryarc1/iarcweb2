...
if($_REQUEST['act']=="edit" && $_REQUEST['id']!=""){
	$cid=$_REQUEST['id'];
	if ($cat = $mysqli->prepare("select *,DATE_FORMAT(pub_date, '%Y-%m-%d %H:%i:%p') from zsp_webinars where inc_id=?")) {
			...
			if($cat->num_rows>0){
				...
				$_SESSION['stat']="NA";
				$allClasses->forRedirect ("addwebinar.php");
			}
		}
		$youtube=mysqli_query($mysqli,"select * from webinar_videos where webinar_id='".$cid."'");
		$youtubeLink = mysqli_fetch_array($youtube);
}else{
...
<div class="container">
	...
	<div class="con_right">
	<form name="frmAddCategory" action="updatewebinarList.php" method="post" enctype="multipart/form-data" onSubmit="return validate()" >
	<?php
    ...
    <div class="width100"  >
		...
		<div class="width100 left">
			<div class="head2"><i class="fa fa-pencil"></i> Edit Webinar </div>
		</div>
						...
						<div class='panel-container'>  
							  ...
							  <div id="ctab1">
								...
								?>
                              	...
                              	<div class="padding10" >
								<div class="head4 width180px left">Webinar Title</div><input name="txtName" type="text" value="<?=$det4?>" class="width60" id="txtName" onChange="setCURL(this.value)" >
								</div>
								<div class="padding10" >
								<div class="head4 width180px left">Webinar Venue</div><input name="txtCode" type="text" value="<?=$det5?>" class="width60" id="txtCode" >
								</div>
								<?=$pub_date?>
									<div class="padding10" >
								<div class="head4 width180px left">Webinar Date</div>
							  ...
							  <div id="ctab3">
								...
								<div class="padding10" >
								<div class="head4 width180px left">Youtube Link.</div><textarea name="txtYoutubeLink" type="text" class="width50" id="txtYoutubeLink" ><?=$youtubeLink['youtube'];?></textarea>
								</div>
