  ...
  <div class="con_right">
    ...
    <div class="topright width100 left">
      ...
      <ul >
        ...
        <li><a href="addevent.php" ><i class="fa fa-plus-square"></i></a></li>
        <?php /*?><li><a href="" ><i class="fa fa-trash"></i></a></li><?php */?>
      </ul>
    </div>
    <div class="width100 left">
      <div class="head2"> <i class="fa fa-list"></i> Events Posted</div>
    ...
    if(@$_GET['BtnNext'] == 'Download'){
         $allClasses->forRedirect("event.php?txtPub=".$_REQUEST['txtPub']."&txtParent=".$_REQUEST['txtParent']);
         exit;
    }
    ...
    <div class="width100 left border" >
      <div class="width100 left border_bottom bgcolor1">
        <div class="head2 width60 left">Events</div>
      ...
      <?php 
        ...
        $where.=" 1=1 ";
        $query = "SELECT * FROM zsp_events $where order by dt_created desc ";
...
if($returnArray[2] >0 ){
      ...
      <div class="width100 left border_bottom <?=$inactve?>">
        ...
        <div class="head4 width10 left onoff"><a href="editevent.php?act=edit&id=<?=$row['inc_id']?>" ><i class="fa fa-pencil-square"></i></a>
        &nbsp;
        <?php if($row['status']==1){ ?>
        <a href="actions.php?act=editSatus&id=<?=$row['inc_id']?>&changeEventStatus=0" ><i class="fa fa-check-circle"></i></a>
        <?php }else{?>
        <a href="actions.php?act=editSatus&id=<?=$row['inc_id']?>&changeEventStatus=1" ><i class="fa fa-circle-thin"></i></a>
        <?php }?>
        &nbsp;
