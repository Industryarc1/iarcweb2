...
if($_POST['butSubmitRB']=="submit"){
	...
	$flag=$stmt->execute();
	if($flag){
		$message = 'Inquiry Before Buying : <br> <br> Report Details <br> <br> Report : '.$_POST['hidReportName'].'<br> Category :'.$_POST['hidCatName'].'<br> Sub Category '.$_POST['hidSubCatName'].'<br><br> Conatct Person Details<br><br>Name : '.$_POST['txtFName'].' '.$_POST['txtLName'].'<br>Email : '.$_POST['txtEmail'].'<br>Phone : '.$_POST['txtPhone'].'<br>Job Title : '.$_POST['txtJTitle'].'<br>Company : '.$_POST['txtCompany'].'<br> Pincode : '.$_POST['txtPin'].'<br>Requirement : <br>'.$_POST['txtComments'];
		$subject = "Inquiry Before Buying : In ".$_POST['hidCatName'];
                ...
                <div class="col2">
                	<div class="row1_1" style="margin-top: 0px;">
                        ...
                        <form action="" method="post" class="pop_form">
                              ...
                              <div class="txt-fld ch-txt-fld" style="width: 100%;">
                                <label for="" >Security Code </label>
                                <img src="images/captcha_code_file.php.jpg">
                                <div style="width: 50%;" class="req_inp">
                                    <input type="text" class="good_input" name="" placeholder="Security Code" kl_virtual_keyboard_secure_input="on">
                                    <div title="" data-original-title="" class="required-icon">
                                        <div class="text">*</div>
                                        <div class="tool-tip left">Required field</div>
                                      </div>
                                </div>
