...
<div class="container">
    ...
    <div class="width100"  >
		<div class="topright width100 left">
			...
			<ul >
				<li><a href="addRLink.php" ><i class="fa fa-plus-square"></i></a></li>
				<?php /*?><li><a href="" ><i class="fa fa-trash"></i></a></li><?php */?>
			</ul>
		</div>
		<div class="width100 left">
			<div class="head2"> <i class="fa fa-list"></i> Links </div>
		...
		<div class="width100 left border" >
			...
			<?php 
				if ($stmt = $mysqli->prepare("select inc_id,title,posted_date,status from zsp_reviews order by posted_date desc")) {
					$stmt->execute();
					$stmt->store_result();
			...
			<div class="width100 left border_bottom <?=$inactve?>">
				...
				<div class="head4 width10 left "><a href="addRLink.php?act=edit&id=<?=$inc_id?>" ><i class="fa fa-pencil-square"></i></a></div>
			</div>
			<?php 
