...
//Table & Page Details
$tableName="zsp_events_whitepprs";
$pageHeading="Event Whitepapers";
$pageAdd="evnt_whitepapers_add.php";
$pageList="evnt_whitepapers.php";
								...
								if(isSet($_REQUEST['id']) && $_REQUEST['id']!=""){
									...
									<div class="width100 padding10" >
										<div class="head4 width220px left">
											<a href="<?=$pageAdd?>?pid=<?=$_REQUEST['id']?>" class="forButton">Add Whitepaper Link</a>
										</div>
									</div>
									<?php
								}
