                	...
                	<div class="row1_1" style="margin-top: 0px;">
						...
						?>
							<div class="txt-fld txt-fld2">
                                ...
                                <div class="req_inp">
                                   <input id="" class="good_input" name="txtFname" type="text" placeholder="Enter Name"  required>
							  ...
							  <div class="txt-fld txt-fld2">
                                ...
                                <div class="req_inp">
                                   <input id="" class="good_input" name="txtPhone" type="text" placeholder="Enter Phone"  required>
                                    <div class="required-icon" data-original-title="" title="">
                                        <div class="text">*</div>
                                        <div class="tool-tip left">Required field</div>
                                  </div>
                          ...
                          <div class="txt-fld txt-fld2">
                              ...
                              <img src="images/ch_arr.png">
                                <input type="submit" name="subRegister" value="Register" class="pop_submit">
                              </div>
                     </form>                        
                     </div>
