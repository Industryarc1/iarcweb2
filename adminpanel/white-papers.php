	...
	<div class="container">
            ...
            <div class="box1" style="margin-top: 12px;">
                ...
                <div class="col5">
					...
					<?php
					$news=mysqli_query($mysqli,"select * from zsp_whitepapers where status=1 order by prod_id desc ");
					if(mysqli_num_rows($news)>0){
					
					?>
					<div class="col5_right">
					    <div style="float:left;color:#666666" class="td_txt1">White Papers </div>
                    </div>
                        	...
                        	<td width="100%" valign="top">
                            	<table width="100%" cellspacing="0" cellpadding="10px" bordercolor="#e4f3f4" border="1" style="border-collapse:collapse">
                                	<tr style="background-color:#38939b; height: 38px;">
                                    	<td width="75%" valign="middle" class="td_txt1 td1">Title</td>
                                        <td width="25%" align="center" valign="middle" class="td_txt1 td2">Published</td>											
                                    </tr>
									<?php
                                    ...
                                    <tr style="background-color:<?=$col?>">                                        
                                        <td class="f_txt1 td1" valign="middle">
                                        	<a href="WhitePaper.php?id=<?=$n['prod_id']?>&title=<?=$n['seo_keyword']?>" class="tb_cont1">
                                            	<?=$n['title']?>
                                            </a>
                                            <?php /*?><div class="tb_cont2">
                                            	By: <?=$row['no_pages']?>
                                            </div><?php */?>
                                           <?php /*?> <div class="tb_cont3">
                                            	<?=nl2br($row['short_descr'])?>... <a href="report.php?id=<?=$row['curl']?>">read more</a>
                                            </div><?php */?>
                                        </td>
                                        <td class="f_txt1 td2" valign="top" align="center"><?=$n['mnfctr']?></td>											
                                    </tr>
                                    <?php $i++; }?>                                                                       
                                </table>
                            </td>
