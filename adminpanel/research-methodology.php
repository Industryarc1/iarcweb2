<?php include_once "includes/config.php";
	$stmt1 = $mysqli->prepare("select content from zsp_content where page_name='Research Methodology' ");
            ...
            <div class="breadcrumbs">
				<ul>
                    ...
                    <li><a href="index.php">Home</a></li>
					 <li><a href="javascript:void(0)">Research Methodology</a></li>
                </ul>
            </div>
            <!--breadcrumbs_end-->
            ...
            <div class="box1" style="margin-top: 12px;">
                ...
                <div class="col5">
					...
					<div class="col5_right">
					    <div style="float:left;color:#666666" class="td_txt1">Research Methodology </div>
