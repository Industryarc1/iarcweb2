...
<div class="container">
  ...
  <div class="con_right">
    ...
    <div class="width100 left">
      ...
      <a href='downloadCLeads.php?id=dl'>Download</a>
    </div>
...
<td width="10%" align="center" valign="middle" class="head3">Country </td>                
                ...
                <td width="10%" align="center" valign="middle" class="head3">Event</td>
                <td width="10%" align="center" valign="middle" class="head3">Type</td>
              </tr>
              
              <?php
              include_once "includes/pagination.php";
							$query = "SELECT inc_id, rid, cid, scid, fname, lname, email, phone, job, company, pincode, comments, dt_created, type, country, ip, industry, revenue, speak_to_alyst, comp_titles FROM zsp_leads_consulting ORDER BY dt_created DESC";
