...
<div class="container">
    ...
    <div class="width100"  >
		<div class="topright width100 left ">
			...
			<ul>
				<li><input type="submit" name="addArticle" value="Save Article" class="forButton fixedclass" ></li>
			</ul>
		</div>
		<div class="width100 left">
			<div class="head2"><i class="fa fa-pencil"></i> Add Article</div>
		</div>
					...
					<div id="tab-container" class='tab-container'>
						...
						<div class='panel-container'>  
							  ...
							  <div id="ctab4">
								...
								<div class="padding10" >
								<div class="head4 width180px left">Custom ID</div><input name="txtCustId" type="text" class="width220px" id="txtCustId" value="" >
