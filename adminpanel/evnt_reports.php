					...
					<div class="width100 left" >
						<div id="tab-container" class='tab-container'>					 
							...
							?> 						 
								...
								<div class="width100 padding10" >
									<div class="head4 width180px left">No Of Reports</div>
							  ...
							  <div id="ctab1"><div id="divImageInfo"></div></div>
								...
								if ($cat1 = $mysqli->prepare("select inc_cat_id,title,link,content,status from $tableName where status=1 and image='0' and link=?")) 
								{
									...
									if($cat1->num_rows>0){
										...
										?>
										<div class="width100 padding10">
												<div class="head2 width70 left bgcolor1">Title</div>									
												<div class="head2 width12 left bgcolor1">Report Code</div>
												<div class="head2 width10 left bgcolor1 onoff">Action</div>
										<?php
										while($cat1->fetch()){
											?>
											
												<div class="head4 width70 left "><?=@$det21?></div>									
												<div class="head4 width12 left "><?=@$det41?></div>
