...
if($_REQUEST['act']=="edit" && $_REQUEST['id']!=""){
	$cid=$_REQUEST['id'];
	if ($cat = $mysqli->prepare("select * from zsp_prs where prod_id=?")) {
			$cat->bind_param('i',$cid );
			$cat->execute();
			$cat->store_result();
			if($cat->num_rows>0){
				$cat->bind_result($det1,$det2,$det3,$det4,$det5,$det6,$det7,$det8,$det9,$det10,$det11,$det12,$det13,$det14,$det15,$det16,$det17,$det18,$det19);
				$cat->fetch();
...
<div class="container">
    ...
    <div class="width100"  >
		<div class="topright width100 left">
			...
			<ul>
				<li>
				  <input type="submit" name="eidtpressrelease" value="Save Pressrelease" class="forButton fixedclass" >
				</li>
			</ul>
		</div>
		<div class="width100 left">
			<div class="head2"><i class="fa fa-pencil"></i> Edit pressReleases </div>
		</div>
					...
					<div id="tab-container" class='tab-container'>
						...
						<div class='panel-container'>  
							  ...
							  <div id="ctab1">
								...
								<div class="padding10" >
								<div class="head4 width180px left">Report Code</div><input name="txtReportCode" type="text" value="<?=$det19?>" class="width60" id="txtReportCode" >
								</div>

								<div class="padding10" >
								<div class="head4 width180px left">Related Report Url</div><input name="txtRelatedUrl" type="text" value="<?=$det18?>" class="width60" id="txtRelatedUrl" >
								</div>
