            ...
            <div class="breadcrumbs">
				<ul>
                    ...
                    <li><a href="index.php">Home</a></li>
					 <li><a href="javascript:void(0)">Media Partners</a></li>
                </ul>
            </div>
            <!--breadcrumbs_end-->
            ...
            <div class="box1" style="margin-top: 12px;">
                ...
                <div class="col5">
					...
					<div class="col5_right">
					    <div style="float:left;color:#666666" class="td_txt1">Media Partners</div>
                            	...
                            	<table width="100%" cellspacing="0" cellpadding="10px"  >
                                    <tr >                                        
                                        <td class="f_txt1 td1" valign="middle">
											...
											while($stmt1->fetch()){
											?>
											<li style="float:left;padding:20px;width:25%"><a><img src="off_imgs/<?=$img?>" style="width:100%"></a></li>
											<?php }
											}?>
											</ul>
                                        </td>
