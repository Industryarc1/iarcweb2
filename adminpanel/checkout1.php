            	...
            	<div class="chck_pg">
                	<div class="chck_left">
                      ...
                      <div class="ch_form">
                   		<div class="ch_left1">
                                    <label>
                                    <img src="images/2co.png">
                                    <br>
                                    <div class="radio1">
                                    <input id="" type="radio" value="checkout">
                                    </div>
                                    </label>
                                </div>
                        <div class="ch_left1">
                           ...
                           <img src="images/paypal.png">
                            <br>
                            <div class="radio1">
                            <input id="" type="radio" value="paypal">
                            </div>
                            </label>
                        </div>
                          </div>
                          ...
                          <div class="ch_form_fter">
                              <div class="ch_con">
                              By clicking on "continue to secure payment" you agree to our <a href="#">terms & condition</a>, <a href="#">return policy</a> and <a href="#">privacy policy</a>. </div>  
                              
                              <div class="ch_sub">
                              	<div class="sub"><img src="images/ch_arr.png"><input type="submit" value="continue to secure payment"></div>
                              </div>
                          </div>                       
                    ...
                    <div class="chck_right">
                    	<div class="report_1">
                            ...
                            <div class="r_2">
                            	World Anti-Counterfeit Electronics and Automobiles Packaging Market
                            </div>
                            <div class="r_3">
                            	Price:   <span style="color: #dd4300">$3930 </span>
                            </div>
                            <div class="r_4">
                            	Licence Type:  Single User License
                            </div>
                        </div>
