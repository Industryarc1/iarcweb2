...
//Table & Page Details
$tableName="zsp_events_news";
$pageHeading="Event News";
$pageAdd="evnt_news_add.php";
$pageList="evnt_news.php";
								...
								if(isSet($_REQUEST['id']) && $_REQUEST['id']!=""){
									...
									<div class="width100 padding10" >
										<div class="head4 width220px left">
											<a href="<?=$pageAdd?>?pid=<?=$_REQUEST['id']?>" class="forButton">Add News</a>
										</div>
									</div>
									<?php
								}
