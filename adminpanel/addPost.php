...
<div class="container">
    ...
    <div class="width100"  >
		<div class="topright width100 left">
			...
			<ul>
				<li><input type="submit" name="addArticle1" value="Save Post" class="forButton fixedclass" ></li>
			</ul>
		</div>
					...
					<div id="tab-container" class='tab-container'>
						...
						<div class='panel-container'>  
							  ...
							  <div id="ctab1">
								...
								<div class="padding10" >
								<div class="head4 width220px left">Report ID (Old Report)</div><input name="txtRID" type="text"  class="width280px" id="txtRID"  >
								</div>
								...
								?>
                              	...
                              	<div class="padding10" >
								<div class="head4 width220px left">Title</div><input name="txtName" type="text" value="<?=@$det4?>" class="width60" id="txtName" onChange="setCURL(this.value)" >
								</div>
								<div class="padding10" >
								<div class="head4 width220px left">Report Code</div><input name="txtCode" type="text" value="<?=@$det4?>" class="width220px" id="txtCode" >
								</div>
								<div class="padding10" >
								...
								<div class="padding10" >
								<div class="head4 width220px left ">Tables and Figures</div>
								<textarea name="txtTAF" type="text" class="width80" id="txtTAF"  ><?=@$det8?></textarea>
								...
								<input name="txtCC" type="text" value="0" class="width280px" id="txtCC"  />
								
								</div>
								
								<div class="padding10" >
								<div class="head4 width220px left ">Region Type(Global/Country)</div>
								<!--<input name="txtRegionType" type="text" class="width280px" id="txtRegionType" required />-->
								...
								<input name="txtRegion" type="text" class="width280px" id="txtRegion"  />
								</div>
							  ...
							  <div id="ctab2">
								...
								<div class="padding10" >
								<div class="head4 width220px left">Image </div><input name="txtImage" type="file" class="width220px"  id="txtImage" value="<?=@$det16?>" >
								<br>
								...
								<input type="radio" name="radType" value="F" > Focussed  Report
							  	...
							  	<div class="padding10" >
								<div class="head4 width220px left">Updated Date</div><input name="txtPD" type="text" placeholder="YYYY-MM-DD" value="<?=@$det10?>" class="width280px" id="txtPD" >
								</div>
								
								<div class="padding10" >
								<div class="head4 width220px left">Published Date</div><input name="txtPDN" type="text" placeholder="YYYY-MM-DD" value="<?=@$det37?>" class="width280px" id="txtPDN" >
								</div>
								...
								<div class="padding10" >
								<div class="head4 width220px left">Author</div><input name="txtNP" type="text"  class="width280px" id="txtNP" value="IndustryARC" >
								</div>
								
								<div class="padding10" >
								<div class="head4 width220px left">No. of Pages</div><input name="txtPages" type="text" value="" class="width280px" id="txtPages" >
								</div>
							  ...
							  <div id="ctab3">
								...
								<div class="padding10" >
								<div class="head4 width220px left">Custom URL</div><input name="txtCURL" type="text" class="width60" value="<?=@$det18?>" id="txtCURL" >
								</div>
								<div class="padding10" >
								<div class="head4 width220px left">Custom breadcrumb tag</div><input name="txtCBCT" type="text" class="width60" value="<?=@$det34?>" id="txtCBCT" >
                              	...
                              	<div class="padding10" >
								<div class="head4 width220px left">Meta Title</div><input name="txtMetaTitle" type="text" class="width220px" value="<?=@$det18?>" id="txtMetaTitle" >
								</div>
								<div class="padding10" >
								<div class="head4 width220px left">Meta Keywrds</div><textarea name="txtMetaKeywords" type="text" class="width50" id="txtMetaKeywords" ><?=@$det19?></textarea>
								</div>	
								<div class="padding10" >
								<div class="head4 width220px left">meta Desc.</div><textarea name="txtMetaDesc" type="text" class="width50" id="txtMetaDesc" ><?=@$det20?></textarea>
								</div>	
								<div class="padding10" >
								<div class="head4 width220px left">SEO Keyword</div><input name="txtSEOKeyword" type="text" class="width220px" id="txtSEOKeyword" value="<?=@$det21?>" >
								<span class="fs10" ></span>
								</div>
								<div class="padding10" >
								<div class="head4 width220px left">Related Reports </div><textarea name="txtRR" type="text" class="width50" id="txtRR" ><?=@$det20?></textarea>
