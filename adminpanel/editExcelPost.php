...
<div class="container">
	...
	<form name="frmAddCategory" action="uploadExcelPost2.php" enctype="multipart/form-data" method="post" >
    <div class="width100"  >
		<div class="topright width100 left ">
			
			<ul>
				<li><input type="submit" name="uploadArticle" value="Save Posts" class="forButton fixedclass" ></li>
			</ul>
		</div>
		...
		<div class="width100 left pb50" >
			<div class="events">
					...
					<div id="tab-container" class='tab-container'>
						<ul class='etabs'>
						   <li class='tab'><a href="#ctab1">Edit reports</a></li>
