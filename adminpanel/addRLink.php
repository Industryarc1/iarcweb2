...
<div class="container">
    ...
    <div class="width100"  >
		<div class="topright width100 left">
			...
			<ul>
				<li><input type="submit" name="addRLink" value="Save Link" class="forButton" ></li>
			</ul>
		</div>
		<div class="width100 left">
			<div class="head2"><i class="fa fa-pencil"></i> Add  Link </div>
		</div>
			...
			<div class="events">
					...
					<div id="tab-container" class='tab-container'>
						...
						if($_REQUEST['act']=="edit" && $_REQUEST['id']!=""){
							$cid=$_REQUEST['id'];
							if ($cat = $mysqli->prepare("select * from zsp_reviews where inc_id=?")) {
									...
									if($cat->num_rows>0){
										...
										echo '<input type="hidden" name="hid_action" value="editlink" />';
										$cat->close();
									}
						...
						?>            
							  <div id="ctab1">
								...
								<input name="txtImage" type="file" value="<?=$det7?>" class="width220px" id="txtImage" > 
								( 185W x 145 H) <br>
								<?php if($det7!=""){ ?>
								...
								<div class="padding10" >
								<div class="head4 width180px left">Description</div><textarea name="txtDescr" type="text"class="width60" id="txtDescr" ><?=$det3?></textarea></div>
								
								
								
								<div class="padding10" >
								<div class="head4 width180px left">Article Link</div><input name="txtDate" type="text" value="<?=$det4?>" class="width60" id="txtDate" ></div>
