...
<div class="container">
    ...
    <div class="width100"  >
		...
		<div class="width100 left">
			<div class="head2"><i class="fa fa-pencil"></i> Add Webinar </div>
		</div>
						...
						<div class='panel-container'>  
							  ...
							  <div id="ctab1">
								...
								?>
                              	...
                              	<div class="padding10" >
								<div class="head4 width180px left">Webinar Title</div><input name="txtName" type="text"  class="width60" id="txtName" onChange="setCURL(this.value)" required >
								</div>
								<div class="padding10" >
								<div class="head4 width180px left">Webinar Venue</div><input name="txtCode" type="text" class="width60" id="txtCode" >
								</div>
								<div class="padding10" >
